...
public class PartitionTest {
    ...
    public void test_partitions_of_2() {
        Partition<Integer> partition = Partition.of(asList(1, 2, 3, 4, 5));
    ...
    @Test
    public void should_fail_for_null_original_list() {
        Throwable result = catchThrowable(() -> Partition.of(null));
